...
#[
    ...
    OA\RequestBody(content: new Model(type: ProductCategoryUpdateRequestUpsertRequest::class))
]
...
final class ProductCategoryUpdatePutAction extends AbstractController
{
    ...
    public function __invoke(int $id, #[RequestBody] ProductCategoryUpdateRequestUpsertRequest $request): JsonResponse
    {
